...
<html lang="es">
  ...
  <head>
    ...
    <link rel="preload" href="<?php echo $ruta['assets'] ?>/css/adminlte.css" as="style" />
    ...
    <link rel="stylesheet" href="<?php echo $ruta['assets'] ?>/css/adminlte.css" />
  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
                ...
                <a href="#" class="dropdown-item">
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0">
                      <img
                        src="<?php echo $ruta['assets'] ?>/assets/img/user1-128x128.jpg"
                        alt="User Avatar"
    ...
    <script src="<?php echo $ruta['assets'] ?>/js/adminlte.js"></script>
